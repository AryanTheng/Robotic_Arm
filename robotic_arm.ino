...
void setup() {
  ...
  servo_0.attach(3); // Associate servo_0 to pin 2
  servo_1.attach(5); // Associate servo_1 to pin 3l
  servo_2.attach(7); // Associate servo_2 to pin 4
  servo_3.attach(9); // Associate servo_3 to pin 5
  servo_4.attach(10); // Associate servo_4 to pin 6
  servo_5.attach(11); // Associate servo_5 to pin 7
  servo_6.attach(13); // Associate servo_6 to pin 8

  servo_0.write(88);   // Safe open position for gripper
  servo_1.write(90);
  servo_2.write(90);
  servo_3.write(90);
  servo_4.write(90);
...
void loop() {
  if (Serial.available() > 0) { // If there is data available to read
    ...
    switch (servoIndex) {
      case 1:
        if (servoValue < 10) servoValue = 10;
        if (servoValue > 88) servoValue = 88;  
